...
// 💡 name을 전부 username으로 대통합!
const initialEmps = [
  {id: "1", username: "John", email: "john@example.com", job: "frontend", pay: 600},
  {id: "2", username: "Peter", email: "peter@example.com", job: "backend", pay: 600},
  {id: "3", username: "Susan", email: "susan@example.com", job: "db", pay: 600},
  {id: "4", username: "Sue", email: "sue@example.com", job: "ai", pay: 600},
]

const initialEmp = {
  id: '', username: '', email: '', job: '', pay:'' // 💡 여기도 username!
}
